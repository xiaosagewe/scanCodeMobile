  ...
  render() {
    return (
      <div class={styles.Index}>
        ...
        <van-row gutter={20}>
          <van-col span={12}>
            <van-button block type="success" native-type="submit" onClick={() => { this.handleScan('') }}>第一个</van-button> 
          </van-col>
          <van-col span={12}>
            <van-button block type="success" native-type="submit" onClick={() => { this.handleScan('2') }}>第二个</van-button>
          </van-col>
          <van-col span={24}>
            <van-cell-group>
